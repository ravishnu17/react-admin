...
const Projects = React.lazy(() => import('./views/karuna/Projects'))
const Patients = React.lazy(() => import('./views/karuna/Patients'))
...
const routes = [
  ...
  { path: '/karuna/projects', name: 'Karuna / projects', element: Projects },
  { path: '/karuna/patients', name: 'Karuna / patients', element: Patients },
  { path: '/highOctavez/events', name: 'High Octavez / Events', element: Events },
